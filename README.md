...
Create a .env file:
GOOGLE\_API\_KEY=your-gemini-api-key-here
...
On first run the app fetches and indexes all handbook pages into chroma\_db folder. Subsequent runs load from disk instantly.
...
ModuleNotFoundError langchain\_chroma: pip install langchain-chroma
